...
export default function ExperienceItem({
  ...
  return (
    <article className="my-6 sm:my-10 relative before:content-[''] before:absolute before:top-[43px] before:bottom-[-21px] before:sm:bottom-[-36px] last-of-type:before:bottom-0 before:left-[16px] before:ml-0.5 before:w-1 before:bg-[#6d0ad5] before:-z-10">
